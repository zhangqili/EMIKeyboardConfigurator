    ...
    constructor() {
        ...
        this.keymap = [
                ...
                [ 
                    ...
                    ((KeyModifier.KeyLeftShift) << 8), KeyCode.Z, KeyCode.X, KeyCode.C, KeyCode.V, KeyCode.B, KeyCode.N, KeyCode.M, KeyCode.Comma, KeyCode.Dot, KeyCode.Slash, ((KeyModifier.KeyRightShift) << 8), KeyCode.UpArrow, KeyCode.Delete,
                    ((KeyModifier.KeyLeftCtrl) << 8), ((KeyModifier.KeyLeftGui) << 8), ((KeyModifier.KeyLeftAlt) << 8), KeyCode.Spacebar, ((KeyModifier.KeyRightAlt) << 8), KeyCode.FN, KeyCode.LeftArrow, KeyCode.DownArrow, KeyCode.RightArrow,
                ],
                Array(64).fill(0),
                Array(64).fill(0),
                Array(64).fill(0)
