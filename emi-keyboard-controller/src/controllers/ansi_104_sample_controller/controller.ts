import { IAdvancedKey, IKeyboardController, IRGBConfig, KeyMode, CalibrationMode, RGBMode, Keycode, KeyModifier, AdvancedKeyToBytes, AdvancedKey, KeyboardController, RGBBaseConfig, IFeature, Feature } from './../../interface';
...
export class ANSI104SampleController extends KeyboardController {
    ...
    async detect(silent: boolean = false): Promise<HIDDevice[]> {
        const targetVendorId = 0xFFFF;
        const targetProductId = 0xFFFF;
        const targetUsagePage = 0xFFC0;
